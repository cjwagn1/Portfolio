	...
	return (
		<Group>
			...
			<Center>
				<Column>
					<ImageGroup>
						<Image src="https://i.imgur.com/KpJUjFq.png" />
						<Image src="https://i.imgur.com/kfXNvty.png" />
					</ImageGroup>

					<TextGroup>
						<Desc>
							PickHacks establishes a hackathon scene for the Midwest. I am the
							frontend developer for the organization.
						</Desc>
						<Inline>
							<a
						...
						<Tech>Tech: HTML/CSS/JavaScript</Tech>
					</TextGroup>
				</Column>
			</Center>
		</Group>
